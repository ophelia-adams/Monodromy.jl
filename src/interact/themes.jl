...
const _COLORS = Dict(
	...
	:grey => RGBf(0.8, 0.8, 0.8),
	:blue => Dict(
		:xlight => RGBf(0.9, 0.94, 1.0),
...
return Theme(
	...
	Toggle = (
		...
		framecolor_inactive = _COLORS[base][:xlight],
	),
	PathPlot = (
